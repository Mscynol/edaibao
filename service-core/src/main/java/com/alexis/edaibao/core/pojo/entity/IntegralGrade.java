package com.alexis.edaibao.core.pojo.entity;
...
public class IntegralGrade implements Serializable {
    ...
    @ApiModelProperty(value = "创建时间", example = "2022-04-12 18:00:00")
    private LocalDateTime createTime;

    @ApiModelProperty(value = "更新时间", example = "2022-04-12 18:00:00")
